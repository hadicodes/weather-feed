  ...
  getCurrentWeather = () => {
    fetch(url)
      ...
      .then(weatherdata => {
        ...
        this.setState({
          currentTemp: weatherdata[0].Temperature.Imperial.Value,
  ...
  render() {
    return (
      <div className="weather-feed container-fluid">
        <Weather
          weatherText={this.state.weatherText ? this.state.weatherText : 'Loading' }
          currentTemp={this.state.currentTemp ? this.state.currentTemp : 'Loading'}
        />
